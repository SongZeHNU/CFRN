...
parser.add_argument('--pth_path', type=str, default='./snapshot/cfrn.pth') #convFSNet-v18-baseline+hploss_l=10+mba_nochannelreduction+norefine_384-epo100
...
print('USE GPU 0')
for _data_name in ['CAMO', 'NC4K']:   #'CAMO', 'COD10K', 'CHAMELEON','NC4K'
